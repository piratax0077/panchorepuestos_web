                ...
                $.ajax({
                    ...
                    success: function(marcas){
                        ...
                        marcas.forEach(marca => {
                            ...
                            $('#imagenes_marcas').append("<div class='col-md-2 col-sm-6 col-6'><a href='/modelos_marca/"+marca.idmarcavehiculo+"' > <img src='http://panchoserver.ddns.net/storage/"+marca.urlfoto+"' alt='' class='imagen_marca_banner'>  </a></div>");
